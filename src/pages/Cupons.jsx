            ...
            <table className="w-full whitespace-nowrap">
              ...
              <tbody className="bg-white divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-800 dark:text-gray-400">
                <tr className>
                    ...
                    <div className="flex items-center">
                      <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                        <img
                          ...
                          src="https://i.ibb.co/23kQcB9/ins3.jpg"
                          alt="product"
                          loading="lazy"
                        />
                        <div
                  ...
                  <td className="px-4 py-2">
                    {" "}
                    <span className="text-sm"> SUMMER24</span>{" "}
                  </td>
                  <td className="px-4 py-2">
                    {" "}
                  ...
                  <td className="px-4 py-2">
                    <span className="text-sm">Aug 1, 2024</span>
                  </td>
                  <td className="px-4 py-2">
                    <span className="text-sm">Oct 19, 2024</span>
                  </td>
                ...
                <tr className>
                  ...
                  <td className="px-4 py-2">
                    <div className="flex items-center">
                      <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://i.ibb.co/wBBYm7j/ins4.jpg"
                          alt="product"
                          loading="lazy"
                        />
                        <div
                  ...
                  <td className="px-4 py-2">
                    <span className="text-sm">Jun 1, 2024</span>
                  </td>
                  <td className="px-4 py-2 align-middle ">
                ...
                <tr className>
                  ...
                  <td className="px-4 py-2">
                    <div className="flex items-center">
                      <div className="relative rounded-full inline-block w-8 h-8 hidden p-1 mr-2 md:block bg-gray-50 shadow-none">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://i.ibb.co/PDLPDHc/ins1.jpg"
                          alt="product"
                          loading="lazy"
                        />
                        <div
                  ...
                  <td className="px-4 py-2">
                    {" "}
                    <span className="text-sm"> AUGUST24</span>{" "}
                  </td>
                  <td className="px-4 py-2">
                    {" "}
                  ...
                  <td className="px-4 py-2">
                    <span className="text-sm">Oct 31, 2024</span>
                  </td>
                  <td className="px-4 py-2 align-middle ">
                    <span className="inline-flex px-2 text-xs font-medium leading-5 rounded-full text-emerald-600 bg-emerald-100 dark:bg-emerald-800 dark:text-emerald-100">
                      Active
