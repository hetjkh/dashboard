      ...
      <div className="sm:container grid lg:px-6 sm:px-4 px-2 mx-auto">
        ...
        <div className="tab tab-enter">
          <div className="min-w-0 rounded-lg overflow-hidden bg-white dark:bg-gray-800 min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 mb-5">
            <div className="p-4">
              <form className="py-3 grid gap-4 lg:gap-6 xl:gap-6 md:flex xl:flex md:justify-between">
                ...
                <div className="lg:flex  md:flex xl:justify-end xl:w-1/2  md:w-full md:justify-start flex-grow-0">
                  ...
                  <button
                    className="align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none px-4 py-2 rounded-lg text-sm text-white bg-emerald-500 border border-transparent active:bg-emerald-600 hover:bg-emerald-600 rounded-md h-12 w-48"
                    type="button"
                  >
                    <span className="mr-2">
                      <svg
            ...
            <table className="w-full whitespace-nowrap">
              ...
              <tbody className="bg-white divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-800 dark:text-gray-400">
                ...
                <tr className>
                  <td className="px-4 py-2">
                    <input
                      id="66ae38f93bdabc223ebd9e49"
                      name="$"
                      type="checkbox"
                    />
                  </td>
                  <td className="px-4 py-2 text-center">
                    <span className="font-medium text-sm">Dollar</span>
                  </td>
                  <td className="px-4 py-2 text-center">
                    <span className="font-medium text-sm">$</span>
                  </td>
                ...
                <tr className>
                  <td className="px-4 py-2">
                    <input
                      id="66ae38f93bdabc223ebd9e4a"
                      name="£"
                      type="checkbox"
                    />
                  </td>
                  <td className="px-4 py-2 text-center">
                    <span className="font-medium text-sm">Pound</span>
                  </td>
                  <td className="px-4 py-2 text-center">
                    <span className="font-medium text-sm">£</span>
                  </td>
                ...
                <tr className>
                  <td className="px-4 py-2">
                    <input
                      id="66af374057631d000cd8b0bb"
                      name="e"
                      type="checkbox"
                    />
                  </td>
                  <td className="px-4 py-2 text-center">
                    <span className="font-medium text-sm">EGP</span>
                  </td>
                  <td className="px-4 py-2 text-center">
